/*! choices.js v11.0.2 | © 2024 Josh Johnson | https://github.com/jshjohnson/Choices#readme */ ! function(e, t) {
    ...
    function n(e, t, i) {
        if (i || 2 === arguments.length)
            for (var n, s = 0, o = t.length; s < o; s++) !n && s in t || (n || (n = Array.prototype.slice.call(t, 0, s)), n[s] = t[s]);
    ...
    var s, o = "ADD_CHOICE",
        ...
        I = (s = document.createElement("div"), function(e) {
            s.innerHTML = e.trim();
        ...
        j = function() {
            ...
            return e.prototype.show = function() {
                return F(this.element, this.classNames.activeState), this.element.setAttribute("aria-expanded", "true"), this.isActive = !0, this
            }, e.prototype.hide = function() {
                return D(this.element, this.classNames.activeState), this.element.setAttribute("aria-expanded", "false"), this.isActive = !1, this
            }, e
        }(),
        R = function() {
            function e(e) {
            ...
            return e.prototype.shouldFlip = function(e, t) {
                ...
                F(this.element, this.classNames.openState), this.element.setAttribute("aria-expanded", "true"), this.isOpen = !0, this.shouldFlip(e, t) && (F(this.element, this.classNames.flippedState), this.isFlipped = !0)
            }, e.prototype.close = function() {
                D(this.element, this.classNames.openState), this.element.setAttribute("aria-expanded", "false"), this.removeActiveDescendant(), this.isOpen = !1, this.isFlipped && (D(this.element, this.classNames.flippedState), this.isFlipped = !1)
            }, e.prototype.addFocusState = function() {
                F(this.element, this.classNames.focusState)
            }, e.prototype.removeFocusState = function() {
                D(this.element, this.classNames.focusState)
            }, e.prototype.enable = function() {
                D(this.element, this.classNames.disabledState), this.element.removeAttribute("aria-disabled"), this.type === _ && this.element.setAttribute("tabindex", "0"), this.isDisabled = !1
            }, e.prototype.disable = function() {
                F(this.element, this.classNames.disabledState), this.element.setAttribute("aria-disabled", "true"), this.type === _ && this.element.setAttribute("tabindex", "-1"), this.isDisabled = !0
                ...
                F(this.element, this.classNames.loadingState), this.element.setAttribute("aria-busy", "true"), this.isLoading = !0
            }, e.prototype.removeLoadingState = function() {
                D(this.element, this.classNames.loadingState), this.element.removeAttribute("aria-busy"), this.isLoading = !1
            }, e
        }(),
        K = function() {
            function e(e) {
        ...
        V = function() {
            ...
            return Object.defineProperty(e.prototype, "isActive", {
                ...
                var e = this.element;
                F(e, this.classNames.input), e.hidden = !0, e.tabIndex = -1;
                var t = e.getAttribute("style");
                t && e.setAttribute("data-choice-orig-style", t), e.setAttribute("data-choice", "active")
            }, e.prototype.reveal = function() {
                var e = this.element;
                D(e, this.classNames.input), e.hidden = !1, e.removeAttribute("tabindex");
        ...
        G = function(e) {
            ...
            return t(i, e), Object.defineProperty(i.prototype, "placeholderOption", {
                ...
                return !e.hasAttribute("value") && e.hasAttribute("placeholder") && (e.setAttribute("value", ""), e.value = ""), {
                    ...
                    labelClass: void 0 !== e.dataset.labelClass ? q(e.dataset.labelClass) : void 0,
            ...
            items: function(e, t, i) {
                ...
                switch (t.type) {
                    ...
                    case d:
                        ...
                        J(t.item), n = n.filter((function(e) {
                            return e.id !== t.item.id
                        }));
                        break;
                    case r:
                        J(t.choice), n = n.filter((function(e) {
    ...
    const ue = e => `Missing ${e} property in key`,
        de = e => `Property 'weight' in key '${e}' must be a positive integer`,
    ...
    function me(e) {
        ...
        if (oe(e) || se(e)) n = e, t = ge(e), i = ve(e);
            ...
            const r = e.name;
            if (n = r, pe.call(e, "weight") && (s = e.weight, s <= 0)) throw new Error(de(r));
            ...
            const s = (e, t, o) => {
                if (ae(e))
                    if (t[o]) {
                        const r = e[t[o]];
                        if (!ae(r)) return;
                        if (o === t.length - 1 && (oe(r) || re(r) || function(e) {
                                return !0 === e || !1 === e || function(e) {
                                    return ce(e) && null !== e
                                }(e) && "[object Boolean]" == le(e)
                            }(r))) i.push(function(e) {
    ...
    class Ee {
        ...
        create() {
            !this.isCreated && this.docs.length && (this.isCreated = !0, oe(this.docs[0]) ? this.docs.forEach(((e, t) => {
                this._addString(e, t)
    ...
    function Ce(e, t, {
        getFn: i = ye.getFn,
        fieldNormWeight: n = ye.fieldNormWeight
    } = {}) {
        const s = new Ee({
            getFn: i,
            fieldNormWeight: n
        ...
        searchIn(e) {
            ...
            this.chunks.forEach((({
                ...
                const {
                    ...
                    if (t.length > we) throw new Error("Pattern length exceeds max of 32.");
                    const l = t.length,
                        u = e.length,
                    ...
                    for (let n = 0; n < l; n += 1) {
                        ...
                        for (let o = v; o >= a; o -= 1) {
                            let r = o - 1,
                                c = i[e.charAt(r)];
                            if (m && (g[r] = +!!c), C[o] = (C[o + 1] << 1 | 1) & c, n && (C[o] |= (_[o + 1] | _[o]) << 1 | 1 | _[o + 1]), C[o] & E && (y = Se(t, {
                                    errors: n,
                                    currentLocation: r,
                                    expectedLocation: d,
                                    distance: s,
                    ...
                    if (m) {
                        const e = function(e = [], t = ye.minMatchCharLength) {
                            let i = [],
                                n = -1,
                                s = -1,
                                o = 0;
    ...
    function Ve(e, t, {
        ...
        const n = e => {
            ...
            if ((e => !se(e) && ce(e) && !Ke(e))(e)) {
                const n = o ? e[Re] : s[0],
                    r = o ? e.$val : e[n];
                if (!oe(r)) throw new Error((e => `Invalid value for key ${e}`)(n));
                const c = {
                    keyId: ve(n),
                    pattern: r
                };
    ...
    class qe {
        constructor(e, t = {}, i) {
            this.options = ne(ne({}, ye), t), this._keyStore = new fe(this.options.keys), this.setCollection(e, i)
        }
        setCollection(e, t) {
            if (this._docs = e, t && !(t instanceof Ee)) throw new Error("Incorrect 'index' type");
        ...
        search(e, {
            ...
            let c = oe(e) ? oe(this._docs[0]) ? this._searchStringList(e) : this._searchObjectList(e) : this._searchLogical(e);
            return function(e, {
                    ignoreFieldNorm: t = ye.ignoreFieldNorm
                }) {
                    e.forEach((e => {
                        let i = 1;
                        e.matches.forEach((({
                    ...
                    ignoreFieldNorm: r
                }), s && c.sort(o), re(t) && t > -1 && (c = c.slice(0, t)),
                function(e, t, {
                    includeMatches: i = ye.includeMatches,
                    includeScore: n = ye.includeScore
                } = {}) {
                    const s = [];
                    return i && s.push(He), n && s.push($e), e.map((e => {
                        const {
                            idx: i
                        } = e, n = {
                            item: t[i],
    ...
    qe.version = "7.0.0", qe.createIndex = Ce, qe.parseIndex = function(e, {
            getFn: t = ye.getFn,
            ...
            constructor(e, {
                ...
                this.query = null, this.options = {
                    ...
                    return e.split("|").map((e => {
                        let i = e.trim().split(ke).filter((e => e && !!e.trim())),
                            n = [];
            ...
            searchIn(e) {
                ...
                for (let n = 0, c = t.length; n < c; n += 1) {
                    ...
                    for (let t = 0, n = c.length; t < n; t += 1) {
                        ...
                        s += 1, r += l, i && (Fe.has(n.constructor.type) ? o = [...o, ...h] : o.push(h))
                    }
                    if (s) {
                        let e = {
                            isMatch: !0,
    ...
    var We = function() {
            ...
            return e.prototype.index = function(e) {
                ...
                return this._fuse || (this._fuse = new qe(this._haystack, this._fuseOptions)), this._fuse.search(e).map((function(e, t) {
                    return {
                        item: e.item,
                        score: e.score || 0,
                        rank: t + 1
        ...
        Ue = function(e, t, i) {
            ...
            o && (n.labelClass = N(o).join(" ")), r && (n.labelDescription = r), i && s && ("string" == typeof s ? n.customProperties = s : "object" != typeof s || function(e) {
                for (var t in e)
        ...
        ze = {
            containerOuter: function(e, t, i, n, s, o, r) {
                ...
                return F(a, c), a.dataset.type = o, t && (a.dir = t), n && (a.tabIndex = 0), i && (a.setAttribute("role", s ? "combobox" : "listbox"), s ? a.setAttribute("aria-autocomplete", "list") : r || Ge(this._docRoot, this.passedElement.element.id, a), a.setAttribute("aria-haspopup", "true"), a.setAttribute("aria-expanded", "false")), r && a.setAttribute("aria-labelledby", r), a
            },
            ...
            itemList: function(e, t) {
                ...
                return F(c, s), F(c, t ? o : r), this._isSelectElement && i && c.setAttribute("role", "listbox"), c
            },
            ...
            item: function(e, t, i) {
                ...
                if (f.dataset.item = "", f.dataset.id = t.id, f.dataset.value = p, Ue(f, t, !0), (t.disabled || this.containerOuter.isDisabled) && f.setAttribute("aria-disabled", "true"), this._isSelectElement && (f.setAttribute("aria-selected", "true"), f.setAttribute("role", "option")), t.placeholder && (F(f, d), f.dataset.placeholder = ""), F(f, t.highlighted ? l : u), i) {
            ...
            choiceList: function(e, t) {
                ...
                return F(n, i), t || n.setAttribute("aria-multiselectable", "true"), n.setAttribute("role", "listbox"), n
            },
            choiceGroup: function(e, t) {
                ...
                F(u, s), h && F(u, r), u.setAttribute("role", "group"), u.dataset.group = "", u.dataset.id = c, u.dataset.value = l, h && u.setAttribute("aria-disabled", "true");
            ...
            choice: function(e, t, i, n) {
                ...
                m.id = t.elementId, F(m, r), F(m, c), n && "string" == typeof p && (p = L(s, p), p = {
                    trusted: p += " (".concat(n, ")")
                });
                var g = m;
                if (t.labelClass) {
            ...
            input: function(e, t) {
                ...
                return r.type = "search", F(r, n), F(r, s), r.autocomplete = "off", r.autocapitalize = "off", r.spellcheck = !1, r.setAttribute("role", "textbox"), r.setAttribute("aria-autocomplete", "list"), t ? r.setAttribute("aria-label", t) : o || Ge(this._docRoot, this.passedElement.element.id, r), r
            },
            dropdown: function(e) {
                var t = e.classNames,
                    i = t.list,
                    n = t.listDropdown,
                    s = document.createElement("div");
                return F(s, i), F(s, n), s.setAttribute("aria-expanded", "false"), s
            },
            notice: function(e, t, i) {
                ...
                return i === ee && (l.dataset.choiceSelectable = "", l.dataset.choice = ""), l
            },
            option: function(e) {
                var t = O(e.label),
                    i = new Option(t, e.value, !1, e.selected);
                return Ue(i, e, !0), i.disabled = e.disabled, e.selected && i.setAttribute("selected", ""), i
            }
        },
        Je = "-ms-scroll-limit" in document.documentElement.style && "-ms-ime-align" in document.documentElement.style,
        Xe = {},
        Qe = function(e) {
    ...
    return function() {
        function e(t, n) {
            ...
            if (!a || "object" != typeof a || "INPUT" !== a.tagName && !U(a)) {
            ...
            if (this.passedElement = this._isTextElement ? new H({
                    element: a,
                ...
                }), this.initialised = !1, this._store = new Q(r), this._currentValue = "", r.searchEnabled = !l && r.searchEnabled || d, this._canSearch = r.searchEnabled, this._isScrollingOnIe = !1, this._highlightPosition = 0, this._wasTap = !0, this._placeholderValue = this._generatePlaceholderValue(), this._baseId = function(e) {
                    var t = e.id || e.name && "".concat(e.name, "-").concat(S(2)) || S(4);
        ...
        return Object.defineProperty(e, "defaults", {
            ...
            if (!this.initialised && void 0 === this.initialisedOK) {
                this._searcher = new We(this.config), this._loadChoices(), this._createTemplates(), this._createElements(), this._createStructure(), this._isTextElement && !this.config.addItems || this.passedElement.element.hasAttribute("disabled") || this.passedElement.element.closest("fieldset:disabled") ? this.disable() : (this.enable(), this._addEventListeners()), this._initStore(), this.initialised = !0, this.initialisedOK = !0;
            ...
            return !i || i.highlighted || (this._store.dispatch(C(i, !0)), t && this.passedElement.triggerEvent(g, this._getChoiceForOutput(i))), this
        }, e.prototype.unhighlightItem = function(e, t) {
            if (void 0 === t && (t = !0), !e || !e.id) return this;
            var i = this._store.items.find((function(t) {
                return t.id === e.id
            }));
            return i && i.highlighted ? (this._store.dispatch(C(i, !1)), t && this.passedElement.triggerEvent("unhighlightItem", this._getChoiceForOutput(i)), this) : this
        }, e.prototype.highlightAll = function() {
            var e = this;
            return this._store.withTxn((function() {
                e._store.items.forEach((function(t) {
                    t.highlighted || (e._store.dispatch(C(t, !0)), e.passedElement.triggerEvent(g, e._getChoiceForOutput(t)))
                }))
            })), this
            ...
            return this._store.withTxn((function() {
                e._store.items.forEach((function(t) {
                    t.highlighted && (e._store.dispatch(C(t, !1)), e.passedElement.triggerEvent(g, e._getChoiceForOutput(t)))
                }))
            })), this
            ...
            return this.dropdown.isActive || requestAnimationFrame((function() {
                ...
                t.containerOuter.open(i.bottom, i.height), !e && t._canSearch && t.input.focus(), t.passedElement.triggerEvent("showDropdown")
            })), this
            ...
            var r = this;
            if (void 0 === e && (e = []), void 0 === t && (t = "value"), void 0 === n && (n = "label"), void 0 === s && (s = !1), void 0 === o && (o = !0), !this.initialisedOK) return this._warnChoicesInitFailed("setChoices"), this;
            if (!this._isSelectElement) throw new TypeError("setChoices can't be used with INPUT based Choices");
            if ("string" != typeof t || !t) throw new TypeError("value parameter must be a name of 'value' field in passed objects");
            if (s && this.clearChoices(), "function" == typeof e) {
                var c = e(this);
                if ("function" == typeof Promise && c instanceof Promise) return new Promise((function(e) {
                ...
                if (!Array.isArray(c)) throw new TypeError(".setChoices first argument function must return either array of choices or Promise, got: ".concat(typeof c));
            ...
            return void 0 === e && (e = !1), void 0 === t && (t = !1), void 0 === i && (i = !1), this._isSelectElement ? (this._store.withTxn((function() {
                ...
                var r = function(e) {
                    i ? n._store.dispatch(E(e)) : o[e.value] && (e.selected = !0)
                };
            ...
            return t ? (this._clearNotice(), this._store.dispatch(b(t)), this._searcher.reset(), t.selected && this.passedElement.triggerEvent(m, this._getChoiceForOutput(t)), this) : this
            ...
            return void 0 === e && (e = !0), this._stopSearch(), e && this.passedElement.element.replaceChildren(""), this.itemList.element.replaceChildren(""), this.choiceList.element.replaceChildren(""), this._store.reset(), this._lastAddedChoiceId = 0, this._lastAddedGroupId = 0, this._searcher.reset(), this
        }, e.prototype.clearInput = function() {
            return this.input.clear(!this._isSelectOneElement), this._stopSearch(), this
        }, e.prototype._validateConfig = function() {
            var e, t, i, n = this.config,
                s = (e = z, t = Object.keys(n).sort(), i = Object.keys(e).sort(), t.filter((function(e) {
            ...
            if (this._canAddItems()) {
                ...
                var a = document.createDocumentFragment(),
                    ...
                    u = function(n, s, o) {
                        ...
                        c = !s && r && c > r ? r : c, c--, n.every((function(n, s) {
                            ...
                            return n.choiceEl = r, a.appendChild(r), n.disabled || !i && n.selected || (l = !0), s < c
                        }))
                    };
                ...
                }))) : u(h(o), !1, void 0)), l || (this._notice || (this._notice = {
                    text: A(i ? t.noResultsText : t.noChoicesText),
                    type: i ? Z : Y
            ...
            void 0 === i && (i = !0);
            var n = this._notice;
            n && (n.type === t && n.text === e || n.type === ee && (t === Z || t === Y)) ? i && this.showDropdown(!0) : (this._clearNotice(), this._notice = e ? {
                text: e,
                type: t
            } : void 0, this._renderNotice(), i && e && this.showDropdown(!0))
        }, e.prototype._clearNotice = function() {
            if (this._notice) {
                var e = this.choiceList.element.querySelector(k(this.config.classNames.notice));
            ...
            var e = this.config,
                t = e.maxItemCount,
                i = e.maxItemText;
            return !(!e.singleModeForMultiSelect && t > 0 && t <= this._store.items.length && (this.choiceList.element.replaceChildren(""), this._displayNotice("function" == typeof i ? i(t) : i, ee), 1))
        }, e.prototype._canCreateItem = function(e) {
            var t = this.config,
                i = !0,
                n = "";
            if (i && "function" == typeof t.addItemFilter && !t.addItemFilter(e) && (i = !1, n = x(t.customAddItemText, e)), i) {
                var s = this._store.choices.find((function(i) {
                    return t.valueComparer(i.value, e)
                }));
                if (this._isSelectElement) {
                    if (s) return this._displayNotice("", ee), !1
                } else this._isTextElement && !t.duplicateItemsAllowed && s && (i = !1, n = x(t.uniqueItemText, e))
            }
            return i && (n = x(t.addItemText, e)), n && this._displayNotice(n, ee), i
            ...
            var s = this._notice;
            return (s && s.type) !== ee && (n.length ? this._clearNotice() : this._displayNotice(A(this.config.noResultsText), Z)), this._store.dispatch(function(e) {
                return {
                    type: c,
                    results: e
                }
            ...
            switch (this._isTextElement || i || (this.showDropdown(), !this.input.isFocussed && n && (this.input.value += e.key, " " === e.key && e.preventDefault())), t) {
                case 65:
            ...
            if (e.preventDefault(), s && s.hasAttribute("data-button")) this._handleButtonAction(s);
                ...
                var o = this.dropdown.element.querySelector(k(this.config.classNames.highlightedState));
                        ...
                        if (this._canAddItems()) {
                            ...
                            this._store.withTxn((function() {
                                if (!(r = i._findAndSelectChoiceByValue(n, !0))) {
                                    ...
                                    var e = w(n),
                                        t = i.config.allowHtmlUserInput || e === n ? n : {
                                            escaped: e,
                                            raw: n
                                        };
                                    i._addChoice(W({
            ...
            t && (e.stopPropagation(), this.hideDropdown(!0), this.containerOuter.element.focus())
        }, e.prototype._onDirectionKey = function(e, t) {
            var i, n, s, o = e.keyCode;
            if (t || this._isSelectOneElement) {
                this.showDropdown(), this._canSearch = !1;
                var r = 40 === o || 34 === o ? 1 : -1,
                    c = void 0;
                if (e.metaKey || 34 === o || 33 === o) c = this.dropdown.element.querySelector(r > 0 ? "".concat(Ye, ":last-of-type") : Ye);
                else {
                    var a = this.dropdown.element.querySelector(k(this.config.classNames.highlightedState));
                    c = a ? function(e, t, i) {
                        void 0 === i && (i = 1);
                        ...
                        return null
                    }(a, Ye, r) : this.dropdown.element.querySelector(Ye)
                }
            ...
            if (t && i.element.contains(t) && !this._isScrollingOnIe) {
                var n = t === this.input.element;
                this._isTextElement || this._isSelectMultipleElement ? n && (i.removeFocusState(), this.hideDropdown(!0), this.unhighlightAll()) : (i.removeFocusState(), (n || t === i.element && !this._canSearch) && this.hideDropdown(!0))
            ...
            if (t.length) {
                ...
                Array.from(this.dropdown.element.querySelectorAll(k(n))).forEach((function(e) {
                    D(e, n), e.setAttribute("aria-selected", "false")
                })), i ? this._highlightPosition = t.indexOf(i) : (i = t.length > this._highlightPosition ? t[this._highlightPosition] : t[t.length - 1]) || (i = t[0]), F(i, n), i.setAttribute("aria-selected", "true"), this.passedElement.triggerEvent("highlightChoice", {
                    el: i
            ...
            (this.config.singleModeForMultiSelect || this._isSelectOneElement) && this.removeActiveItems(e.id), this._store.dispatch(function(e) {
                return {
                    type: u,
                    item: e
                }
            }(e)), t && (this.passedElement.triggerEvent("addItem", this._getChoiceForOutput(e)), i && this.passedElement.triggerEvent("choice", this._getChoiceForOutput(e)))
        }, e.prototype._removeItem = function(e) {
            e.id && (this._store.dispatch(E(e)), this.passedElement.triggerEvent(m, this._getChoiceForOutput(e)))
            ...
            var n = this.config;
            if (!this._isSelectElement && n.duplicateItemsAllowed || !this._store.choices.find((function(t) {
                ...
                var s = n.prependValue,
                    r = n.appendValue;
                s && (e.value = s + e.value), r && (e.value += r.toString()), (s || r) && e.element && (e.element.value = e.value), this._clearNotice(), this._store.dispatch(function(e) {
                    return {
                        type: o,
                        choice: e
                    }
                }(e)), e.selected && this._addItem(e, t, i)
            }
